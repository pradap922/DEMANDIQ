...
from rag_light import rag_answer
from forecast_service import (
    get_store_dept_options,
    get_history,
    get_summary,
    get_forecast
)
...
@app.route("/")
def home():
    # Landing page (your big homepage UI)
...
def login():
    ...
    if request.method == "POST":
        ...
        if u == "adminiq@gmail.com" and p == "admin@123":
            session["user"] = u
...
def api_forecast():
    try:
        ...
        safety_percent = float(request.args.get("safety", 0.1))
